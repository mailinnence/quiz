...
public class button_back_mode : MonoBehaviour
{
    ...
    void ToggleState()
    {
        ...
        {
            buttonText.text = PlayerPrefs.GetString("set_background_on") + " " +"ON";
            isOn = true;
        } 
        else
        {   buttonText.text = PlayerPrefs.GetString("set_background_on") + " " +"OFF";
            isOn = false;
        }
    }
    ...
    void UpdateVisual()
    {
        ...
        plainText.text = PlayerPrefs.GetString("set_background_on_plainText");
        if(isOn)
        {
            isOn = false;
            buttonText.text = PlayerPrefs.GetString("set_background_on") + " " +"OFF";
